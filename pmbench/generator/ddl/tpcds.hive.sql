...
row format delimited fields terminated by '|' 
location '${DIR}/customer_demographics';
...
row format delimited fields terminated by '|' 
location '${DIR}/household_demographics';
