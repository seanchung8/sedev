...
//					actor.tell(generateEvent(), this.getSender());
					this.context().system().scheduler().scheduleOnce(scala.concurrent.duration.Duration.create(timeline, TimeUnit.MILLISECONDS), actor, generateEvent(), this.context().system().dispatcher(), this.getSender());
				}
...
//					actor.tell(event, this.getSender());
					...
					context().system().scheduler().scheduleOnce(scala.concurrent.duration.Duration.create(timeline, TimeUnit.MILLISECONDS), actor, generateEvent(), this.context().system().dispatcher(), this.getSender());
				}	
